                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-sm-flex align-items-baseline report-summary-header">
                          <h5 class="font-weight-semibold">Resumen</h5> <span class="ml-auto">Actualizar Resumen</span> <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="row ">
...
?>
                          <span class="report-title">Total de Clases</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> Ver Clases</span></a>
                        </div>
...
?>
                          ...
                          <a href="manage-students.php"><span class="report-count"> Ver Estudiantes</span></a>
                        </div>
                        <div class="inner-card-icon ">
                          <i class="icon-user"></i>
                        </div>
...
?>
                          <span class="report-title">Noticias de Clases</span>
...
?>
                          <span class="report-title">Noticias Publicas</span>
                          <h4><?php echo htmlentities($totpublicnotice);?></h4>
                          <a href="manage-public-notice.php"><span class="report-count"> Ver</span></a>
                        </div>
                        <div class="inner-card-icon">
                          <i class="icon-doc"></i>
                        </div>
